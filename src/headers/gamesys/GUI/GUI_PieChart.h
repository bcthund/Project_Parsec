	...
	namespace GUI {
		namespace Object {
			...
			class PieChart : virtual public Base::Generic<Props_PieChart> {
				public:
//					PieChart();
//					PieChart(std::string n, Props_Window &c);
//					PieChart(Props &p,std::string n, Props_Window &c);
//					PieChart(std::string n, Props_Window *c);
//					PieChart(Props &p,std::string n, Props_Window *c);
//					~PieChart();
//
...
//
//			PieChart::PieChart() { iScrollIndex	= 0; }
//
//			PieChart::Window(std::string n, Props_Window &c) {
//				name			= n;
//
//				bHasParent		= false;
//				parent			= nullptr;
...
//			}
//
//			PieChart::PieChart(Props &p, std::string n, Props_Window &c) {
//				name			= n;
//
//				bHasParent		= true;
//				parent			= &p;
...
//			}
//
//			PieChart::PieChart(std::string n, Props_Window *c) {
//				name			= n;
//
//				bHasParent		= false;
//				parent			= nullptr;
...
//			 */
//			void PieChart::checkScrollVisibility() {
